...
int aliceVision_main(int argc, char* argv[])
{
    ...
    optionalParams.add_options()
        ...
        ("flipNormals", po::value<bool>(&flipNormals)->default_value(flipNormals),
         "Option to flip face normals. It can be needed as it depends on the vertices order in triangles and the convention change "
        ...
        ("subdivisionTargetRatio", po::value<float>(&texParams.subdivisionTargetRatio)->default_value(texParams.subdivisionTargetRatio),
         "Percentage of the density of the reconstruction as the target for the subdivision (0: disable subdivision, "
         "0.5: half density of the reconstruction, 1: full density of the reconstruction).");
